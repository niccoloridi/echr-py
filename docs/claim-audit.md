...
The current release-preparation pass contains 655 passing offline tests and six
...
| Mumford annotations | Pinned revision `166b15c31276bfa8c8775e7e7def575e916aced7`; [repository](https://github.com/jamumford/ECHR-citation-context-v1) declares CC0-1.0. Local import found 115 curated XMI documents, 5,481 curated annotations, and 8,899 individual-annotator annotations. The historical 78.2% figure is an occurrence-reusing identity/context proxy, not strict span recovery. The final v3 full-inclusive run aligns 4,535/5,425 selected ECHR labels (83.6%) after unique XMI-Sofa projection, with 447 ambiguity abstentions and 443 unmatched annotations. These are selected-annotation recovery measures, not detector precision. Among 1,302 aligned references receiving an automatic target with application-number evidence, all 1,302 agree with the printed application number; this is conditional agreement, not procedural-document accuracy. The [methodology audit](mumford-methodology-audit.md) explains the scope, abstentions, and a source-document grouping defect in the published repetition analysis. |
